...
class ContentTaskCompletedLastMonth extends React.Component {
  state = { tasks: [] };
      ...
      <div>
        <div className="myContentLayout">
          <div className="myContent">
            ...
            <p>
              <h3>Completed last month Page</h3>
            </p>
...
export default ContentTaskCompletedLastMonth;
